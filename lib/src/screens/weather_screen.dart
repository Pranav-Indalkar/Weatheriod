    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: Column(
            ...
            children: <Widget>[
              // Center(child: Text(_cityName+", "+_countryName)),
              // Text(
              //   DateFormat('EEEE, d MMMM yyyy').format(DateTime.now()),
              //   style: TextStyle(
              //     color: appTheme.accentColor.withAlpha(125),
              //     fontSize: 14,
              //   ),
              // )
              Text(
          ...
          actions: <Widget>[
            IconButton(
              ...
              onPressed: (){
                Map map = new Map();
                map['weatherBloc'] = _weatherBloc;
                map['cityName'] = _cityName;
                Navigator.of(context).pushNamed("/settings",arguments: map);
              },
            ),
          ...
          child: Container(
            decoration: BoxDecoration(
              ...
              image: DecorationImage(
                image: AppStateContainer.of(context).themeCode == 0 ? AssetImage("assets/night.png") : AssetImage("assets/day.png"),
                fit: BoxFit.fill
              )
            ),
            child: FadeTransition(
              ...
              child: BlocBuilder<WeatherBloc, WeatherState>(
                ...
                if (weatherState is WeatherLoaded) {
                  ...
                  this._countryName = weatherState.weather.countryCode;
